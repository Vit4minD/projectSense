        ...
        const fetchUserData = async () => {
            if (user) {
                ...
                if (docSnapshot.exists()) {
                    ...
                    const oldtime = data[13] || ''; // replace 'oldtime' with the actual key
                    setBestTime(oldtime);
                }
            }
        };
    ...
    const generateRandomNumbers = () => {
        ...
        switch (index) {
            case 0: // big multi
                ...
                break;
            case 1:
                const num11 = Math.floor(Math.random() * 85000 + 11000), num22 = Math.floor(Math.random() * 45 + 12)
                setNum(num11)
                setRemainder(num22)
                setAns(num11 / num22)
                break;
        ...
        if (estimation(Number(userAns), ans)) {
            ...
            if (problems == 4) {
                ...
                if (timeCompare(oldtime, time)) {
                    ...
                    const userDocumentRef2 = doc(db, 'leaderboard', '13' ?? '');
        ...
        return (
            <main className="h-screen overflow-auto w-screen  bg-orange-300">
                <div className="bg-white text-5xl p-10 text-orange-300 flex font-bold justify-center items-center">
                    ...
                    <div className="absolute text-2xl md:text-3xl">Number Sense: Estimation</div>
