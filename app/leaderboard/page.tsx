                ...
                <div className='w-4/5 text-center overflow-y-auto'>
                    ...
                    {sortedTimes.map((item, index) => (
                        <div key={index} className="flex justify-between text-orange-300 mx-auto w-4/5 my-6  font-bold">
                            <div className='bg-white p-4 text-4xl rounded-3xl '>{index + 1}</div>
                            <div className='bg-white p-4 text-4xl rounded-3xl w-3/5'>{item.substring(9, item.indexOf("@"))}</div>
                            <div className='bg-white p-4 text-4xl rounded-3xl'>
                                {item.substring(0, 8)}
                            </div>
                        </div>
                    ))}
